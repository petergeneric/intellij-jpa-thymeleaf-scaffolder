<#-- @ftlvariable name="entity" type="com.peterphi.scaf.jpathymeleaf.plugin.thymeleaf.formgen.PersistentMember" -->
...
<#-- @ftlvariable name="field" type="com.peterphi.scaf.jpathymeleaf.plugin.thymeleaf.formgen.PersistentMember" -->
    <input
            type="text"
            id="${formId}"
            name="${field.name}"
